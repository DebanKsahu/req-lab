...
var __r={tests:[],logs:[],envVars:{},globalVars:{},collVars:{},reqVars:{},mutations:{url:null,method:null,body:null,headers:{},queryParams:{}},error:null,sendRequests:[]};
...
var __ns={test:test,expect:expect,response:response,request:request,environment:environment,env:environment,globals:globals,global:globals,collectionVariables:collectionVariables,collection:collectionVariables,variables:variables,vars:variables,console:__console,info:{requestName:'',requestId:'',iteration:1,iterationCount:1,eventName:''},iterationData:{get:function(){return undefined;},has:function(){return false;},toObject:function(){return {};}},cookies:{get:function(){return undefined;},has:function(){return false;},jar:function(){return{get:function(){return undefined;},set:function(){},unset:function(){},clear:function(){}};}},sendRequest:__sendReq};
""".trimIndent()
