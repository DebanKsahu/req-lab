...
/**
 * GraalVM Polyglot JS runtime for Android (JVM).
 *
 * Identical to the Desktop implementation. Works for Android unit tests
 * (which run on the host JVM). For on-device execution a lighter engine
 * such as Mozilla Rhino could be substituted later.
 */
